...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="http://www.samuajasa.com/sjadmin" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>S</b>J</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Samua<b>Jasa</b></span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form class="form-horizontal" action="<?=base_url();?>index.php/admin/tambah_aksi" method="post">
<fieldset>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="id_jasa">ID Jasa</label>  
  <div class="col-md-4">
  <input id="id_jasa" name="id_jasa" type="text" placeholder="ID Jasa" class="form-control input-md" value="<?=$kode;?>"readonly>
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="Jasa">Nama Jasa</label>  
  <div class="col-md-4">
  <input id="Jasa" name="jasa" type="text" placeholder="Nama Jasa" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <div class="input-group">
      ...
      <input id="harga" name="harga" class="form-control" placeholder="cth: 5000" type="text">
    </div>
    <p class="help-block">Format ribuan tanpa "."</p>
  </div>
</div>

<!-- File Button --> 
<div class="form-group">
  <label class="col-md-4 control-label" for="Gambar">Gambar Jasa</label>
  <div class="col-md-4">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="overview">Overview</label>
  <div class="col-md-4">                     
